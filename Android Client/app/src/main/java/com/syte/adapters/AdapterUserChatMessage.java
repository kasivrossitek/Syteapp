 ...
 */
public class AdapterUserChatMessage extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    {
        private ArrayList<ChatMessage> chatMessages;
        private ArrayList<String> chatMessagesIds;
        private Firebase firebaseChatMessage,firebaseYasPaseemyChatUnReadCount;
        public AdapterUserChatMessage(ArrayList<ChatMessage> paramChatMessages,ArrayList<String> paramChatMessagesIds,Firebase paramFirebaseChatMessage,Firebase paramFirebaseYasPaseemyChatUnReadCount)
            {
                ...
                this.firebaseYasPaseemyChatUnReadCount=paramFirebaseYasPaseemyChatUnReadCount;
            }
        ...
        public int getItemViewType(int position)
            {
                ...
                if (chatMessage.getcSenderType()==SENDER_USER)
                    {
                        return SENDER_USER;
                    }
                else
