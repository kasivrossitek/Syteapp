 ...
 */
public class AdapterSponsorInnerChat extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    {
        private ArrayList<SponsorInnerMessage> mMyChats;
        ...
        public AdapterSponsorInnerChat(ArrayList<SponsorInnerMessage> yasPaseeChats, int paramDimenProfilePic,OnMessageItemClick MessageItemClick)
            {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position)
            {
                ...
                final SponsorInnerMessage yasPaseeChat = mMyChats.get(position);
                viewHolder.getmTvSyteName().setText(yasPaseeChat.getUserName());
                mDisplayImage(yasPaseeChat.getUserProfilePic(), viewHolder.getmIvSyteImage());
                ...
                relativeLayout.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        {
                            onMessageItemClick.onSponsorInnerMessageItemClciked(yasPaseeChat);
                        }
                    });
