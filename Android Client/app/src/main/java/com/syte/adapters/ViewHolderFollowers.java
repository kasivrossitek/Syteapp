...
public class ViewHolderFollowers extends RecyclerView.ViewHolder {
    ...
    public void setmIvTmProfilePic(ImageView param) {
        this.mIvTmProfilePic = param;
    }

    public void setmRelLayTeamMemberVwHolder(RelativeLayout param) {
        this.mRelLayTeamMemberVwHolder = param;
    }

    public void setmTvTmName(TextView param) {
        this.mTvTmName = param;
    }

    public ImageView getmIvTmProfilePic() {
        return this.mIvTmProfilePic;
    }

    public RelativeLayout getmRelLayTeamMemberVwHolder() {
        return this.mRelLayTeamMemberVwHolder;
    }

    public TextView getmTvTmName() {
        return this.mTvTmName;
    }
}
