...
public class AdapterWhatsapp extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public AdapterWhatsapp(ArrayList<String> myWAContacts_id, ArrayList<Followers> mFollower, ArrayList<String> authored_numbers, ArrayList<PhoneContact> myWAContacts, Syte mySyte, String mySyteId, YasPasPreferences mYasPasPref, int dimen, Context applicationContext) {
            ...
            public void onClick(View v) {
                ...
                if (cont_id != null) {
                    ...
                    if (numbers != null) {
                        ...
                        sendWhatsapp(numbers.get(0), cont_id);
    ...
    public class ViewHolderContactlist extends RecyclerView.ViewHolder {
        private ImageView mProfilePic, mInvitefnd, mFollowfnd, mUnFollowfnd;
