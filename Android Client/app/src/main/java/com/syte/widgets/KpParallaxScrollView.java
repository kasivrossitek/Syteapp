 ...
 */
public class KpParallaxScrollView extends ScrollView {
    ...
    private ArrayList<KpParallaxedView> parallaxedViews = new ArrayList<KpParallaxedView>();

    public KpParallaxScrollView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public KpParallaxScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public KpParallaxScrollView(Context context) {
        super(context);
    }
    ...
    private void makeViewsParallax() {
        if (getChildCount() > 0 && getChildAt(0) instanceof ViewGroup) {
            ...
            for (int i = 0; i < numOfParallaxViews; i++) {
                KpParallaxedView parallaxedView = new ScrollViewParallaxedItem(viewsHolder.getChildAt(i));
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        for (KpParallaxedView parallaxedView : parallaxedViews) {
    ...
    protected class ScrollViewParallaxedItem extends KpParallaxedView {
