...
public class EnlargeImageDialog {
    ...
    public void sShowEnlargeImageDialog() {
        ...
        ImageView img_close = (ImageView) window.findViewById(R.id.close);
        mDisplayImage(image, loading, DIALOG, img_close);
    }

    private void mDisplayImage(ImageView image, final ProgressBar loading, final Dialog DIALOG, ImageView img_close) {
