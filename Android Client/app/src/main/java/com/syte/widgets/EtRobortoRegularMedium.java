 ...
 */
public class EtRobortoRegularMedium extends EditText
{

    public EtRobortoRegularMedium(Context context)
    {
        super(context);
        // TODO Auto-generated constructor stub
        this.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf"));
        this.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.edittext_medium_txt_sz));
    ...
    public EtRobortoRegularMedium(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        this.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf"));
        this.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.edittext_medium_txt_sz));
    ...
    public EtRobortoRegularMedium(Context context, AttributeSet attrs, int defStyle)
    {
