...
public class MediaUploadService extends Service {
    ...
    public void onCreate() {
        ...
        myaspaspref = YasPasPreferences.GET_INSTANCE(getApplicationContext());
                    ...
                    if (!_cloudinary_id.trim().trim().equalsIgnoreCase(MediaUploadService.DUMMY_URL)) {
                        ...
                        if (c_id.trim().length() > 0) {
                            ...
                            if (_media_tar == SyteDataBaseConstant.C_MEDIA_TAR_SYTE_BANNER) {
                                if (myaspaspref.sGetSyteType().equalsIgnoreCase("Private")) {
                                    mUpdatePrivateSyte(_syte_id, _firebase_id, c_id, _id, syteDataBase);
                                } else {
                                    mUpdatePublicSyte(_syte_id, _firebase_id, c_id, _id, syteDataBase);
                                }
                            }
                            ...
                            if (_media_tar == SyteDataBaseConstant.C_MEDIA_TAR_FEED_BACK_PIC) {
                                mUpdateFeedback(_syte_id, _firebase_id, c_id, _id, syteDataBase);
                            }
                            if (_media_tar == SyteDataBaseConstant.C_MEDIA_TAR_REPORT_A_SYTE_PIC) {
                                mUpdateReportSyte(_syte_id, _firebase_id, c_id, _id, syteDataBase);
                            }
                        }
                    }
                    return null;
...
//                            tmpFile = tmp;
    ...
    private void mUpdatePrivateSyte(final String _syte_id, final String _firebase_id, final String _cloudinary_id, final int _local_id, final SyteDataBase syteDataBase) {
    ...
    }// END mUpdatePrivateSyte()

    private void mUpdatePublicSyte(final String _syte_id, final String _firebase_id, final String _cloudinary_id, final int _local_id, final SyteDataBase syteDataBase) {
        Firebase mFireBsYasPasObj = new Firebase(StaticUtils.YASPAS_URL).child(_syte_id);
        HashMap<String, Object> mUpdateMap = new HashMap<String, Object>();
        mUpdateMap.put("imageUrl", _cloudinary_id);
        mUpdateMap.put("dateModified", ServerValue.TIMESTAMP);
        mFireBsYasPasObj.updateChildren(mUpdateMap, new Firebase.CompletionListener() {
            ...
            public void onComplete(FirebaseError firebaseError, Firebase firebase) {
                if (firebaseError == null) {
                    final Firebase mFireBsYasPaseeObj = new Firebase(StaticUtils.PUBLIC_YASPAS).child(_syte_id);
                    HashMap<String, Object> mUpdateMap1 = new HashMap<String, Object>();
                    mUpdateMap1.put("imageUrl", _cloudinary_id);
                    mFireBsYasPaseeObj.updateChildren(mUpdateMap1, new Firebase.CompletionListener() {
                        @Override
    ...
    private void mUpdateFeedback(final String _syte_id, final String _firebase_id, final String _cloudinary_id, final int _local_id, final SyteDataBase syteDataBase) {

        HashMap<String, Object> mUpdateMap = new HashMap<String, Object>();
        mUpdateMap.put("imageUrl", _cloudinary_id);
        Firebase firebaseYasPasee = new Firebase(StaticUtils.YASPASEE_URL).child(_firebase_id).child("feedback");
        firebaseYasPasee.setValue(mUpdateMap, new Firebase.CompletionListener() {
            @Override
            public void onComplete(FirebaseError firebaseError, Firebase firebase) {
                if (firebaseError == null) {
                    ...
                    YasPasPreferences yasPasPreferences = YasPasPreferences.GET_INSTANCE(getApplicationContext());
                    yasPasPreferences.sSetFeedbackImgUrl(_cloudinary_id);
                    syteDataBase.sDeleteMedia(_local_id);
    ...
    private void mUpdateReportSyte(final String _syte_id, final String _firebase_id, final String _cloudinary_id, final int _local_id, final SyteDataBase syteDataBase) {


        HashMap<String, Object> mUpdateMap = new HashMap<String, Object>();
        mUpdateMap.put("imageUrl", _cloudinary_id);
        Firebase firebaseYasPasee = new Firebase(StaticUtils.YASPASEE_URL).child(_firebase_id).child("Reportasyte").child(_syte_id);
        firebaseYasPasee.setValue(mUpdateMap, new Firebase.CompletionListener() {
            @Override
            public void onComplete(FirebaseError firebaseError, Firebase firebase) {
                if (firebaseError == null) {
