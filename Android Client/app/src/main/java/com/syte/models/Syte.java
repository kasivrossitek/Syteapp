...
public class Syte implements Parcelable {
    ...
    private String name, mobileNo, category, emailId, website; // Syte details
    ...
    public void setStreetAddress1(String paramStAdd1) {
        this.streetAddress1 = paramStAdd1;
    }
    ...
    public void setStreetAddress2(String paramStAdd2) {
        this.streetAddress2 = paramStAdd2;
    }
    ...
    public void setZipCode(String paramZipCode) {
    ...
    public void setMobileNo(String paramMobile) {
        this.mobileNo = paramMobile;
    }
    ...
    public void setAboutUs(AboutUs paramAboutUs) {
        this.aboutUs = paramAboutUs;
    }
    ...
    public void setWhatWeDo(WhatWeDo paramWhatWeDo) {
        this.whatWeDo = paramWhatWeDo;
    }

    public WhatWeDo getWhatWeDo() {
        return this.whatWeDo;
    }

    public void setDateCreated(Object paramDtCreated) {
        this.dateCreated = paramDtCreated;
    }
    ...
    public void setDateModified(Object paramDtModified) {
        this.dateModified = paramDtModified;
    }
    ...
    public void setDateDeleted(Object paramDtDeleted) {
        this.dateDeleted = paramDtDeleted;
    }
    ...
    public void setIsDeleted(int paramIsDeleted) {
        this.isDeleted = paramIsDeleted;
    }
    ...
    public void setOpenForBiz(int paramOpenForBiz) {
        this.openForBiz = paramOpenForBiz;
    }

    public int getOpenForBiz() {
        return this.openForBiz;
    }

    public void setMessagingEnabled(int paramMessagingEnabled) {
        this.messagingEnabled = paramMessagingEnabled;
    }

    public int getMessagingEnabled() {
    ...
    public void setLatestBulletin(String paramBulletin) {
        this.latestBulletin = paramBulletin;
    }

    public String getLatestBulletin() {
        return this.latestBulletin;
    }
