            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    ...
                    while (iteratorFollowers.hasNext()) {
                        ...
                        Log.d("invitetofollow key", abc);
                        if (abc.equalsIgnoreCase(invitedYasPasPush.getRegisteredNum())) {
                            Firebase fb = firebaseUpdateInviteStatus.child(abc);
                            fb.getRef().removeValue();
                            Log.d("invitetofollow removed", "successfully");
