...
/**
 * Created by Administrator on 29-04-2016.
 */
public class WalkThroughSettingsActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId())
            {
                case R.id.xRelLayBack:{finish();break;}
        ...
        protected void onCreate(Bundle savedInstanceState)
            {
                ...
                setContentView(R.layout.activity_walk_through_settings);
                mInItObjects();
                mInItWidgets();
            }//END onCreate()
