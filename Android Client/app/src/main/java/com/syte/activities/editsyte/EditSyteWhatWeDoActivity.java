 ...
 */
public class EditSyteWhatWeDoActivity extends Activity implements View.OnClickListener, OnCustomDialogsListener {
        ...
        protected void onCreate(Bundle savedInstanceState)
            {
                ...
                setContentView(R.layout.activity_edit_syte_what_we_do);
                mInItObjects();
                mInItWidgets();
                mSetValues();
            }// END onCreate()
        private void mInItObjects()
            {
                ...
                mNetworkStatus=new NetworkStatus(EditSyteWhatWeDoActivity.this);
                mPrgDia = new ProgressDialog(EditSyteWhatWeDoActivity.this);
                                ...
                                if(mValidateData())
                                    {
                                        if(mNetworkStatus.isNetworkAvailable())
                                                        ...
                                                        public void onComplete(FirebaseError firebaseError, Firebase firebase)
                                                            {
                                                                if(firebaseError==null)
                                                                    ...
                                                                    {
                                                                        mPrgDia.dismiss();
                                                                        CustomDialogs customDialogs = CustomDialogs.CREATE_DIALOG(EditSyteWhatWeDoActivity.this, EditSyteWhatWeDoActivity.this);
                                            ...
                                            {
                                                CustomDialogs customDialogs = CustomDialogs.CREATE_DIALOG(EditSyteWhatWeDoActivity.this,this);
