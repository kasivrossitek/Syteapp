...
public class BulletinSponsorReadMoreActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, OnBulletinBoardUpdate,OnCustomDialogsListener {
...

    {
        ...
        adapterBulletinBoardReadMoreSponsor=new AdapterBulletinBoardReadMoreSponsor(BulletinSponsorReadMoreActivity.this,bulletinBoards,bulletinBoardsIds,this);
                ...
                if(!it.hasNext())
                {
                    try
                    {
                        if (!isFinishing())
                        {
                            ...
                            adapterBulletinBoardReadMoreSponsor=new AdapterBulletinBoardReadMoreSponsor(BulletinSponsorReadMoreActivity.this,bulletinBoards,bulletinBoardsIds,BulletinSponsorReadMoreActivity.this);
                            mVpBulletinBoard.setAdapter(adapterBulletinBoardReadMoreSponsor);
                            mVpBulletinBoard.invalidate();
