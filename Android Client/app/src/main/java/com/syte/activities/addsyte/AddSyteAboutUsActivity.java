 ...
 */
public class AddSyteAboutUsActivity extends Activity implements View.OnClickListener, OnCustomDialogsListener {
        ...
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            setContentView(R.layout.acitivity_add_syte_about_us);
            mInItObjects();
            mInItWidgets();
            mSetValues();
        }// END onCreate()
        private void mInItObjects()
            {
                ...
                mNetworkStatus=new NetworkStatus(AddSyteAboutUsActivity.this);
                mPrgDia = new ProgressDialog(AddSyteAboutUsActivity.this);
                                ...
                                if(mValidateData())
                                    {
                                        if(mNetworkStatus.isNetworkAvailable()) {
                                            ...
                                            mFireBsYasPasObj.setValue(aboutUs, new Firebase.CompletionListener() {
                                                ...
                                                public void onComplete(FirebaseError firebaseError, Firebase firebase) {
                                                    if (firebaseError == null)
                                                        ...
                                                        mPrgDia.dismiss();
                                                        CustomDialogs customDialogs = CustomDialogs.CREATE_DIALOG(AddSyteAboutUsActivity.this, AddSyteAboutUsActivity.this);
                                            ...
                                            {
                                                CustomDialogs customDialogs = CustomDialogs.CREATE_DIALOG(AddSyteAboutUsActivity.this,this);
