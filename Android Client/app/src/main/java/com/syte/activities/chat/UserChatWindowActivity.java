...
public class UserChatWindowActivity extends AppCompatActivity implements View.OnClickListener, OnCustomDialogsListener {
    ...
    public void onResume() {
        ...
        mYasPasPref.sSetOnGoingChatId(mYasPasPref.sGetRegisteredNum());
                ...
                public void onComplete(FirebaseError firebaseError, Firebase firebase) {
                    firebase.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            firebaseYasPaseemyChat.setPriority(0 - (long) chatMessageAdded.getcDateTime(), new Firebase.CompletionListener() {
                                @Override
                                public void onComplete(FirebaseError firebaseError, Firebase firebase) {
    ...
    private void sendChatPushNotification(ChatMessage chatMessage) {
        ...
        chatMessagePush.setcChatId(mYasPasPref.sGetRegisteredNum());
        chatMessagePush.setcSenderName(chatMessage.getcSenderName());
        chatMessagePush.setImgUrl(mYasPasPref.sGetUserProfilePic());
